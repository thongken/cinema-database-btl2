...
VALUES
('KM001', N'Thứ 3 vui vẻ', N'Áp dụng suất chiếu thứ 3', '2024-01-01','2024-12-31', 20000),
('KM002', N'Ưu đãi thành viên Silver', N'Khách Silver trở lên', '2024-01-01','2024-12-31', 15000),
('KM003', N'Combo vé + bắp', N'Mua vé kèm combo', '2024-02-01','2024-12-31', 10000),
('KM004', N'Giảm sinh viên', N'Có thẻ sinh viên', '2024-03-01','2024-06-30', 25000),
('KM005', N'Black Friday', N'Ngày 29/11', '2024-11-29','2024-11-29', 50000);
...
VALUES
('SC001','PH001','P001','2024-11-25','09:00','11:30',90000, N'Đang mở'),
('SC002','PH002','P001','2024-11-25','12:00','14:00',80000, N'Đang mở'),
('SC003','PH003','P002','2024-11-25','15:00','17:30',95000, N'Đang mở'),
('SC004','PH004','P003','2024-11-26','10:00','12:00',70000, N'Đang mở'),
('SC005','PH005','P004','2024-11-26','13:00','15:30',90000, N'Đang mở');
